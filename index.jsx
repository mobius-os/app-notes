...
function ColorPicker({ anchorRef, current, onPick, onDismiss, placement = "above", align = "start" }) {
	...
	const height = rows * 44 + (rows - 1) * 8 + 16 + 2;
	useLayoutEffect(() => {
		function place() {
...
function noteOpenLabel(meta = {}, body = "", date = "") {
	...
	return `Open untitled note: ${firstMeaningfulLine(body) || (meta.type === "checklist" ? "Empty checklist" : "Empty note")}${date ? `, ${date}` : ""}`;
}
//#endregion
...
const mathSpansField = StateField.define({
	create(state) {
...
function EditorPanel({ note, onSave, onBack, onDelete, resolveAttachment, putAttachment, status, forceSave, closeRequestRef, inactive = false, isDraft = false }) {
	...
	useEffect(() => {
		...
		Promise.all(refs.map(async (ref) => ({
			ref,
			url: await resolveAttachment(ref).catch(() => null)
		}))).then((resolved) => {
		...
		children: /* @__PURE__ */ jsxs("section", {
			...
			children: [
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("div", {
									className: "nt-editor-actions nt-desktop-only",
									role: "toolbar",
						...
						/* @__PURE__ */ jsxs("div", {
							className: "nt-mobile-note-options",
							role: "toolbar",
							...
							children: [
								/* @__PURE__ */ jsxs("button", {
									...
									children: [/* @__PURE__ */ jsx(Icon, {
										name: "pin",
										size: 15
									}), /* @__PURE__ */ jsx("span", { children: note.meta.pinned ? "Unpin" : "Pin" })]
								}),
								/* @__PURE__ */ jsxs("button", {
									type: "button",
									onClick: toggleColorPicker,
								...
								/* @__PURE__ */ jsxs("button", {
									...
									children: [/* @__PURE__ */ jsx(Icon, {
										name: locked ? "edit" : "lock",
										size: 15
									}), /* @__PURE__ */ jsx("span", { children: locked ? "Edit" : "Read-only" })]
								}),
								/* @__PURE__ */ jsxs("button", {
									type: "button",
									onClick: () => onDelete(note.meta.id),
				...
				/* @__PURE__ */ jsxs("footer", {
					...
					children: [
						/* @__PURE__ */ jsx("span", { children: isDraft ? "New note" : editorDate(note.meta) }),
						/* @__PURE__ */ jsxs("span", { children: [
							count,
							" word",
							count === 1 ? "" : "s"
						] }),
						isDraft && /* @__PURE__ */ jsx("span", { children: "Autosaves as you type" }),
						tasks && /* @__PURE__ */ jsx("span", { children: tasks }),
						locked && /* @__PURE__ */ jsx("span", { children: "Read-only" })
					]
				}),
				strandedItems.length > 0 && /* @__PURE__ */ jsx("div", {
					className: "nt-attach-strip",
					"aria-label": "Attached images",
					children: strandedItems.map((item, index) => /* @__PURE__ */ jsx("img", {
						src: item.url,
...
function EmptyState({ filtered, onCreate, onClear }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			filtered && /* @__PURE__ */ jsx("button", {
				type: "button",
				className: "nt-empty-action nt-empty-action--secondary",
				onClick: onClear,
...
function App({ appId }) {
	...
	const doDelete = useCallback(async (id) => {
		...
		if (n?.meta?.locked) {
			setSaveError({
				id,
				kind: "delete",
				message: "Allow edits before deleting this note."
			});
			return;
		}
		if (n) try {
	...
	const undoDelete = useCallback(async () => {
		...
		try {
			await collection.update(meta.id, () => ({
				meta,
				body
			}));
			setNotesNow((prev) => prev.some((note) => note.meta.id === meta.id) ? prev : [{
				meta,
				body
			}, ...prev]);
			setRecentlyDeletedNow(null);
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("style", { children: CSS }), /* @__PURE__ */ jsxs(ErrorBoundary, { children: [
			...
			recentlyDeleted && /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("span", {
					className: "nt-undo-toast-copy",
					children: recentlyDeleted.error || `Deleted “${recentlyDeleted.label}”.`
				}), /* @__PURE__ */ jsx("button", {
					type: "button",
			...
			!online && view.mode !== "editor" && !recentlyDeleted && /* @__PURE__ */ jsx("div", {
